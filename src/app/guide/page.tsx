    ...
    <main className="mx-auto max-w-6xl px-4 pb-20 pt-[calc(var(--header-height,56px)+16px)] text-white">
      ...
      <header className="mb-8 space-y-3">
        ...
        <p className="max-w-3xl text-lg opacity-90">
          Tout ce qu’il faut savoir pour t’inscrire, laisser le staff créer les équipes,
          lancer la draft, suivre les matchs et voter les MVPs. <b>Scroll en douceur.</b>
        </p>
      </header>
      ...
      {/* Layout desktop avec TOC STICKY dans un rail à gauche */}
